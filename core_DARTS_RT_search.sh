...
python3 $DARTS/intermediate_scripts/mod_mmseq_outfile_farser.py gRT_$2_elements.mmseqs80-80_cluster.tsv gRT_$2_elements.faa
...
python $DARTS/intermediate_scripts/adapt_coordinates_to_bam.py $2_elements Coords_1step.bam qwerty_table
