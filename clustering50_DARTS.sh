...
mmseqs easy-cluster gRT_$2_elements.faa gRT_$2_elements.mmseqs50-80 tmp --min-seq-id 0.5 -c 0.8 #--cov-mode 1
python $DARTS/intermediate_scripts/mod_mmseq_outfile_farser.py gRT_$2_elements.mmseqs50-80_cluster.tsv gRT_$2_elements.faa
...
mkdir mmseq2-50
cp mmseq_delegates_gRT_$2_elements.faa ./mmseq2-50/gRT-$2_delegates.faa
for i in {'gRH','aRH','GAG','INT','PRo'}; do cp rewrited_$i-domain_$2_elements_delegates.faa ./mmseq2-50/$i-$2_delegates.faa; done
